export const project7dCompass = {
   data: {
      ...
      links: [
         { type: "demo", url: "https://7d-compass.com/" }
      ],
      ecosystem: [
         {
   ...
   en: {
      ...
      description: "Financial reconciliation platform for the construction industry, automating audits for $2.3M USD in transactions and reducing operational time by 95%.",
      fullDescription: "7D-Compass is a high-performance auditing ecosystem designed for Seven D Construction (Chicago). It automates 95% of financial reconciliation by centralizing bank records and operational data through a robust Angular/Node.js architecture.",
      challenge: {
         description: "Manual reconciliation of millions in construction transactions was error-prone and took hundreds of work hours monthly. Discrepancies often went undetected for billing cycles.",
         solution: "A centralized audit engine with complex validation logic that flags discrepancies in real-time, reducing the monthly reconciliation window from weeks to hours."
      },
      ecosystem: {
         items: [
            {
               title: "Administrative Web Portal",
               description: "Centralized dashboard for office staff to manage financial data, visualize predictive analytics, and oversee automated audit results with granular RBAC."
            },
            {
               title: "On-site Mobile App",
               description: "Cross-platform mobile client for field workers to log real-time operational data, ensuring seamless data flow from the job site to the auditing engine."
            },
            {
               title: "Node.js Audit Engine",
               description: "High-throughput backend that processes $2.3M USD in transactions, performing complex reconciliation between multiple data sources."
            }
         ]
      }
   },
   es: {
      ...
      challenge: {
         description: "La conciliación manual de millones en transacciones de construcción era propensa a errores y consumía cientos de horas mensuales. Las discrepancias a menudo no se detectaban durante ciclos de facturación completos.",
         solution: "Un motor de auditoría centralizado con lógica de validación compleja que marca discrepancias en tiempo real, reduciendo la ventana de conciliación mensual de semanas a horas."
      },
      ecosystem: {
         items: [
            {
