export const projectDabetai = {
   data: {
      ...
      techStack: ["astro", "angular", "reactnative", "expo", "tailwindcss", "nestjs", "postgresql", "fastapi", "mongodb", "python"],
      links: [
   ...
   en: {
      ...
      description: "Preventive ecosystem connecting wearables with medical dashboards, enabling real-time risk prediction and improving response efficiency by ~40%.",
      fullDescription: "A comprehensive health platform moving beyond simple monitoring to active prevention. dabetai leverages wearable technology and AI to predict critical complications like Retinopathy and Nephropathy before they become irreversible.",
      challenge: {
         description: "Diabetes management is often reactive. Patients lack visibility into the silent progression of dangerous complications, while doctors suffer from a lack of continuous, real-time data.",
         solution: "An interconnected ecosystem that fuses real-time biological data with clinical oversight, utilizing predictive models to alert both patients and doctors about specific risks."
      },
      ecosystem: {
         items: [
            /* {
