export const cta = {
   ...
   es: {
      ...
      description:
         "Actualmente estoy disponible para roles de tiempo completo y proyectos desafiantes. Hablemos de cómo puedo ayudar a tu equipo a escalar.",
      projectDescription:
         "¿Te interesa el impacto de {project}? Hablemos sobre cómo puedo aportar una excelencia técnica similar a tu próxima gran idea.",
      actions: {
         talk: "Hablemos",
         copy: "Copiar correo",
      },
