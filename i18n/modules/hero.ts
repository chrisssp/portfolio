export const hero = {
   en: {
      ...
      roles: [
         ...
         "Mobile & Cross-Platform Architect",
         "AI-Augmented Development",
         "HealthTech & Fintech Builder",
   ...
   es: {
      ...
      roles: [
         "Ingeniero full-stack y móvil",
         "Creando ecosistemas con IA",
         "Resolviendo problemas reales con código",
         "De hackathons a producción",
         "Ingeniería de backends escalables",
         "Arquitecto móvil multiplataforma",
         "Desarrollo aumentado por IA",
         "Construyendo HealthTech y Fintech",
         "Convirtiendo ideas en impacto",
