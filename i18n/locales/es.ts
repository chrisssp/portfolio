...
export const es: Dictionary = {
   ...
   projects: {
      title: "Proyectos",
      subtitleLink: "Revisa mis repositorios en GitHub",
      sections: {
   ...
   blog: {
      title: "Blog",
      subtitle:
         "Un espacio personal donde comparto mi flujo de trabajo, los proyectos que tengo entre manos y lo que pienso sobre desarrollo e IA.",
      searchPlaceholder: "Buscar posts...",
      filterByTags: "Filtrar por etiquetas:",
      tagFilterPrefix: "Etiqueta:",
      noArticlesTitle: "No se encontraron posts",
      noArticlesDescription:
         "Prueba ajustar tu búsqueda o los criterios de filtro.",
      readMore: "Leer más",
