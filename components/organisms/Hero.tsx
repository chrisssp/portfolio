                        ...
                        {dict.hero.stats.map((stat) => (
                           ...
                           >
                              <div className="cursor-default transition-opacity duration-200 group-hover:opacity-40 hover:!opacity-100">
                                 <span className="inline-flex items-baseline gap-1.5 px-4 py-2 rounded-full bg-surface border border-subtle/80 text-sm leading-snug transition-all duration-200 ease-out hover:-translate-y-1 whitespace-nowrap">
                                    <Typography
                                       variant="small"
                                       as="span"
                                       weight="bold"
