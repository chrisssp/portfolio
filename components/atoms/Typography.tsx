...
export const Typography = ({ 
   ...
   const variants = {
      ...
      "hero-sub": "text-[18px] xs:text-[22px] sm:text-[32px] md:text-[40px] lg:text-[48px] font-bold leading-tight",
      // Muy pequeño: 20px | Tablet: 28px | Desktop: 32px
      section: "text-[20px] xs:text-[24px] sm:text-[28px] md:text-[30px] lg:text-[32px] font-bold leading-tight",
      // Muy pequeño: 16px | Tablet: 20px | Desktop: 24px
      project: "text-[16px] xs:text-[18px] sm:text-[22px] md:text-[24px] font-bold leading-tight",
