...
import { MdEmail, MdArrowDropDown, MdContentCopy, MdCheck } from "react-icons/md";
   ...
   return (
      <div className={`relative ${className}`} ref={menuRef}>
         ...
         >
            ...
            <MdArrowDropDown className={`ml-0.5 size-4 sm:size-5 transition-transform duration-300 ${showEmailMenu ? 'rotate-180' : ''}`} />
         </Button>

         {showEmailMenu && (
            <>
               {/* Backdrop for mobile to focus on the centered menu */}
               <div className="fixed inset-0 bg-black/20 backdrop-blur-sm z-[9998] lg:hidden" onClick={() => setShowEmailMenu(false)} />
